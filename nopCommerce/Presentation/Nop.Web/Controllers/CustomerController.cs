...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        private readonly Inop_demoService _nopDemoService;
        ...
        public CustomerController(
            Inop_demoService _nopDemoService,
        ...
        {
            this._nopDemoService = _nopDemoService;
      ...
      /// <returns></returns>
        ...
        {
            Nop_Demo dem = new Nop_Demo { Active=false,
                Deleted=false,
                describe="测试程序"
            };
            _nopDemoService.InsertNopDemo(dem);
