...
{
    /// <summary>
    /// Dependency registrar注册了NopCommerce的核心类
    /// </summary>
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            //在IoC容器中把PerRequestCacheManager注册为ICacheManager，并且命名为nop_cache_per_request。
            ...
            //注册work context和store context
            builder.RegisterType<WebWorkContext>().As<IWorkContext>().InstancePerLifetimeScope();
            builder.RegisterType<WebStoreContext>().As<IStoreContext>().InstancePerLifetimeScope();

            //注册业务层services，部分需注册缓存参数，可以看到WithParameter( ResolvedParameter.ForNamed< ICacheManager >("nop_cache_static" ))
            ...
            builder.RegisterType<Nop_demoService>().As<Inop_demoService>().InstancePerLifetimeScope();
