...
namespace Nop.Core.Infrastructure
{
    ...
    public class Singleton<T> : Singleton
    {
        ...
        /// <summary>指定类型T的单例实例。每个类型T只有一个该对象的实例（在该时间）。
        /// The singleton instance for the specified type T. Only one instance (at the time) of this object for each type of T.</summary>
