...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        /// <param name="categoryIds">CategoryId</param>
        /// <param name="manufacturerId">制造商ID; 0表示返回所有记录</param>
        /// <param name="storeId">商店ID; 0表示返回所有记录</param>
        /// <param name="vendorId">供应商ID; 0表示返回所有记录</param>
        /// <param name="warehouseId">仓库ID; 0表示返回所有记录</param>
        /// <param name="productType">商品类型; 0表示返回所有记录</param>
        /// <param name="visibleIndividuallyOnly">是否只加载标记为“单独可见”的产品; "false"加载所有; "true"只加载 "visible individually"</param>
        /// <param name="markedAsNewOnly">是否只加载标记为“新”的产品; "false"加载所有; "true"只加载"marked as new"</param>
        /// <param name="featuredProducts">A value indicating whether loaded products are marked as featured (relates only to categories and manufacturers). 0 to load featured products only, 1 to load not featured products only, null to load all products</param>
        /// <param name="priceMin">最低价格; null加载所有记录</param>
        /// <param name="priceMax">最高价格；null加载所有记录</param>
        /// <param name="productTagId">商品标记ID; 0加载所有</param>
        /// <param name="keywords">关键字</param>
        /// <param name="searchDescriptions">是否按照产品说明中指定的“关键字”进行搜索的值</param>
        /// <param name="searchManufacturerPartNumber">是否通过制造商部件号中的指定“关键字”进行搜索的值</param>
        /// <param name="searchSku">是否按产品SKU中的指定“关键字”进行搜索的值</param>
        /// <param name="searchProductTags">是否按产品标签中的指定“关键字”进行搜索的值</param>
        /// <param name="languageId">LanguageId</param>
        /// <param name="filteredSpecs">过滤的产品规格标识符</param>
